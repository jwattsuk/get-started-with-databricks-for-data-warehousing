...
-- MAGIC    1. Select **Create > Table** from the top-right corner.
...
-- MAGIC
-- MAGIC ![lakeflow_connect.png](../Includes/images/lakeflow_connect.png)
-- MAGIC
-- MAGIC After clicking on the **Databricks connector** (eg. Salesforce) you want to work with, it will take you to the following tab, where you can fill in the specifications
-- MAGIC
-- MAGIC ![demo_lakeflow_connect_specifications.png](../Includes/images/demo_lakeflow_connect_specifications.png)
-- MAGIC
