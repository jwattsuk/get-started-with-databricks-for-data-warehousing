...
-- MAGIC
-- MAGIC 1. With the **Datasets list** icon selected, click the **+ Add data source** button. </p>
...
-- MAGIC 1. Return to the **Untitled page** tab. </p>
...
-- MAGIC 3. Under <b>Sharing settings</b>, choose <b>Anyone in my account can view</b> from the drop-down. Then, close the <b>Sharing</b> dialog.
-- MAGIC
-- MAGIC 4. Use the context icon at the top of the dashboard next to the dashboard name to switch between **Edit Draft** and **View Published** versions of your dashboard.
-- MAGIC
...
-- MAGIC   
-- MAGIC 6. <p style="color: #0873FF"> Apply the following settings: </p>
-- MAGIC   - <b>Filter</b>: Single value
-- MAGIC   - <b>Fields</b>: 
-- MAGIC       - sales.total_price 
-- MAGIC       - Count Total Sales.Sales_Goal
-- MAGIC 7. <p style="color: #0873FF"> Use the checkboxes to turn on <b>Title</b>. </p>
-- MAGIC 8. <p style="color: #0873FF"> Double-click the title on the widget and change it to <b>Product category</b> </p>
-- MAGIC 9. <p style="color: #0873FF"> Use the drop-down in the filter widget to test your filter `(e.g., 3000000)`. </p>
-- MAGIC
...
-- MAGIC
-- MAGIC ![Dashboard_Solution](../Includes/images/05_Dashboard_Solution_New_One.png)
