...
# MAGIC %md
# MAGIC # Silver to Gold DLT Pipeline
...
# MAGIC The pipeline Workflow will be modified to include the following notebooks:
# MAGIC
# MAGIC - Pipelines/Autoloader to Bronze
# MAGIC - Pipelines/Bronze to Silver
# MAGIC - Pipelines/Silver to Gold
# MAGIC
# MAGIC **This will:**
# MAGIC
# MAGIC > - Search for the pipeline by its name (Workflow).
# MAGIC > - Update the pipeline with the specified notebooks.
...
# MAGIC - This function continuously checks the status of the pipeline and logs the progress, such as:
# MAGIC
# MAGIC     - RUNNING
# MAGIC     - COMPLETED
# MAGIC     - FAILED
