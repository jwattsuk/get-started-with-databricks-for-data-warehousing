...
# MAGIC
# MAGIC * **Download a File**:
# MAGIC    - Right-click on a file in the Workspace.
# MAGIC    - Choose **Download as** and select the desired download format.
# MAGIC    - Alternatively, navigate to folder in which the file is present.
# MAGIC    - Click on the **( ⋮ )** kebab icon and select **Download as**.
# MAGIC    - Select the desired download file type.
# MAGIC
...
# MAGIC
# MAGIC 1. Navigate to **Catalog** in the sidebar and search for the catalog we made earlier. 
